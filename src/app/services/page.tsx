...
const services = [
  {
    ...
    desc: "Bespoke marketing engines designed to explain complex software, engage prospective clients, and capture high-intent leads. We combine visual storytelling with high-fidelity interactive details.",
    features: [
      "Custom UI/UX Design System",
      "Interactive Product Demonstrations",
      "Structure Optimization",
      "Modular Content Block Management",
    ],
    outcome: "Increased user signups and immediate credibility with venture partners.",
  },
  {
    id: "landing-pages",
    title: "Landing Pages",
    ...
    features: [
      "Persuasive Copywriting Flow",
      "Optimized Interactive States",
      "Sub-800ms Core Web Vitals",
      "Seamless Lead Form Integrations",
    ],
    outcome: "Lower Customer Acquisition Cost (CAC) and higher return on marketing spend.",
  },
  {
    id: "business-websites",
    title: "Business Websites",
    desc: "Elegant, high-performance visual systems designed to command authority and communicate premium value. We focus on visual trust and clean storytelling.",
    features: [
      "Editorial Layout Structure",
      "Multi-page Architecture Planning",
      "Brand Visual System Alignment",
      "High-contrast Responsive Spacing",
    ],
    outcome: "Establishing clear market authority and elevating customer trust metrics.",
  },
  {
    id: "portfolio-websites",
    title: "Portfolio Websites",
    desc: "Bespoke editorial showcases crafted for creative leaders, design agencies, and verified professionals who refuse standard templates.",
    features: [
      "Custom Layout Transitions",
      "Immersive Micro-animations",
      "High-end Typography Rhythms",
      "Tactile Mouse Cursor Interactions",
    ],
    outcome: "Immediate conversion of curiosity into creative inquiries and projects.",
  },
  {
    id: "redesign",
    ...
    features: [
      "User Experience Alignment Audit",
      "Modern Grid Hierarchy Design",
      "Performance Code Optimization",
      "Fluid Layout Spacing Adjustments",
    ],
  ...
  },
  {
    ...
    desc: "Dedicated engineering support, layout performance reviews, and regular accessibility updates to secure your digital presence.",
    features: [
      "Continuous Speed Monitoring",
      "Monthly Conversion Audits",
      "Accessibility Standards Checks",
      "Routine Quality Adjustments",
    ],
