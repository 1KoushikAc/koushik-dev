...
export const metadata: Metadata = {
  title: "ONJI Case Study — Koushik",
  description: "ONJI: Reimagining the friction of creative marketplace discovery and professional connection.",
};
          ...
          <div className="lg:col-span-8 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <FadeIn delay={0.25} className="w-full">
                <div className="border border-gray-800 bg-white/[0.01] rounded-xl p-6 h-full">
