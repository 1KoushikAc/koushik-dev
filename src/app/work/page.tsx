...
export const metadata: Metadata = {
  title: "Selected Creations — Koushik",
  description: "A curated showcase of premium digital experiences designed and engineered to solve complex business constraints.",
};
